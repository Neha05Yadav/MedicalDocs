...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Securely store, manage, and share your medical records across any hospital or clinic with MediDoc." },
      { property: "og:title", content: "MediDoc — Your Health Records, Unified" },
      { property: "og:description", content: "Securely store, manage, and share your medical records across any hospital or clinic." },
    ],
  }),
  component: HomePage,
});
...
function HeroSection() {
  return (
    <section className="max-w-7xl mx-auto px-6 pt-20 pb-16">
      ...
      <div className="mt-12 rounded-2xl ring-1 ring-black/5 shadow-2xl shadow-brand/5 overflow-hidden">
        <img
          src={heroImage}
          alt="MediDoc patient dashboard preview"
