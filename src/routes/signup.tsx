...
import { Eye, EyeOff, Mail, Lock, User, ArrowLeft, Shield, Phone } from "lucide-react";
import { toast } from "sonner";

export const Route = createFileRoute("/signup")({
  head: () => ({
    meta: [
      { title: "Sign Up — MediDoc" },
      { name: "description", content: "Create your MediDoc account." },
    ],
  }),
    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        <div className="mb-8">
          ...
          <p className="text-sm text-muted-foreground mt-1">Start managing your health records today.</p>
        </div>
        ...
        <form onSubmit={handleSignUp} className="space-y-4">
          ...
          <div>
            <label className="text-sm font-medium mb-1.5 block">Mobile Number (optional)</label>
            <div className="relative">
