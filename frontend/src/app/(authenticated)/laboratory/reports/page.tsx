  ...
  return (
    <div className="p-8 max-w-7xl mx-auto w-full bg-[#f8f9fc] min-h-screen">
      <header className="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-[#1a2b4b]">Lab Reports</h1>
          <p className="text-sm text-slate-500 mt-1">Manage uploaded reports and dispatch new results to patients.</p>
        </div>
        ...
        <div className="flex items-center bg-slate-100 p-1 rounded-xl w-fit">
          ...
          >
            <Eye className="size-4" /> View Uploaded
          </button>
          <button 
          ...
          >
            <FileUp className="size-4" /> Upload Result
          </button>
        </div>
      </header>
