    ...
    <div className="p-8 max-w-7xl mx-auto w-full min-h-screen font-sans">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-end gap-4 mb-8">
        <button 
          ...
          className="bg-amber-600 hover:bg-amber-700 text-white px-4 py-2 rounded-xl text-sm font-bold shadow-sm transition-colors flex items-center gap-2"
        >
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-4 mb-6 flex flex-col sm:flex-row gap-4 justify-between items-center">
        ...
        <div className="relative w-full sm:w-80">
          ...
          <input 
            ...
            className="w-full pl-9 pr-4 py-2 border border-slate-200 rounded-xl text-sm font-medium focus:outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 transition-all"
          />
        </div>
      </div>
      {/* Lab Grid */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredLabs.map(lab => (
          <div key={lab.id} className="bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-md hover:border-amber-200 transition-all overflow-hidden flex flex-col">
            ...
            <div className="p-3 border-t border-slate-100 flex gap-2">
              <button 
                ...
                className="flex-1 py-2 text-sm font-semibold text-slate-700 bg-white border border-slate-200 rounded-lg hover:border-amber-300 hover:text-amber-700 transition-colors"
              >
                View Details
              </button>
              <div className="relative">
                <button 
                  ...
                  className="p-2 text-slate-400 bg-white border border-slate-200 rounded-lg hover:border-amber-300 hover:text-amber-600 transition-colors"
                >
                ...
                {openDropdownId === lab.id && (
                  <div className="absolute right-0 bottom-full mb-2 w-32 bg-white border border-slate-200 shadow-lg rounded-xl overflow-hidden z-10 animate-in fade-in zoom-in-95 duration-200">
                    <button 
                      ...
                      className="w-full text-left px-4 py-2.5 text-sm font-semibold text-slate-700 hover:bg-slate-50 hover:text-amber-600 flex items-center gap-2"
                    >
      ...
      {filteredLabs.length === 0 && (
        <div className="text-center py-20 bg-white rounded-2xl border border-slate-200 border-dashed">
          <FlaskConical className="size-12 text-slate-300 mx-auto mb-3" />
          <h3 className="text-lg font-bold text-slate-700 mb-1">No labs found</h3>
          ...
          <div className="bg-white rounded-2xl max-w-4xl w-full shadow-xl overflow-hidden flex flex-col max-h-[90vh]">
            ...
            <div className="p-6 overflow-y-auto flex-1 bg-slate-50/50">
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm">
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-semibold text-slate-800 flex items-center gap-2"><Phone className="size-3 text-slate-400" /> {selectedLab.phone}</p>
                        <p className="text-sm font-medium text-slate-600 flex items-start gap-2 mt-2"><MapPin className="size-3 text-slate-400 mt-0.5 shrink-0" /> {selectedLab.address}</p>
                      </div>
                    </div>
                  </div>
                  {/* Statistics */}
                ...
                {/* Right Column: Tests, Staff & Activity */}
                <div className="lg:col-span-2 space-y-6">
                  {/* Available Test Types */}
                  <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm">
                    <div className="flex items-center justify-between mb-4">
                      <h4 className="text-sm font-bold text-slate-900 flex items-center gap-2">
                        <TestTube2 className="size-4 text-purple-600" />
                        Available Test Types
                      </h4>
                    </div>
          ...
          <div className="bg-white rounded-2xl max-w-2xl w-full shadow-xl overflow-hidden flex flex-col max-h-[90vh]">
            <div className="flex items-center justify-between p-6 border-b border-slate-100 shrink-0">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-slate-900 text-lg">Add New Laboratory</h3>
                  <p className="text-xs text-slate-500">Register a new diagnostic center or lab</p>
                </div>
              </div>
              <button 
