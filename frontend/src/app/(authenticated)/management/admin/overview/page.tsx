...
// Mock Data
const kpiData = [
  { title: "Total Patients", value: "24,592", trend: "+12.5%", isPositive: true, icon: Users, color: "text-blue-600", bg: "bg-blue-50" },
  { title: "Total Doctors", value: "1,204", trend: "+4.2%", isPositive: true, icon: Stethoscope, color: "text-emerald-600", bg: "bg-emerald-50" },
  { title: "Total Hospitals", value: "84", trend: "+2.1%", isPositive: true, icon: Hospital, color: "text-purple-600", bg: "bg-purple-50" },
  { title: "Total Labs", value: "45", trend: "0.0%", isPositive: true, icon: FlaskConical, color: "text-amber-600", bg: "bg-amber-50" },
  { title: "Total Reports", value: "142k", trend: "+18.4%", isPositive: true, icon: FileText, color: "text-rose-600", bg: "bg-rose-50" },
];
const userDistributionData = [
  { name: 'Patients', value: 85, color: '#3b82f6' },
  { name: 'Doctors', value: 10, color: '#10b981' },
  { name: 'Staff', value: 5, color: '#8b5cf6' },
];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
        ...
        <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
          <div className="flex items-center justify-between mb-6">
            <h3 className="font-bold text-slate-900 text-lg">User Distribution</h3>
          </div>
