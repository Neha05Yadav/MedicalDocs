...
export default function DoctorDashboard() {
  ...
  const kpiCards = [
    { label: "Total Patients", value: "1,248", icon: Users, color: "border-[#0891b2]", bgColor: "bg-cyan-50 text-[#0891b2]" },
    { label: "Pending Reports", value: "5", icon: FileText, color: "border-amber-500", bgColor: "bg-amber-50 text-amber-600" },
    { label: "Reviewed Reports", value: "87", icon: CheckCircle2, color: "border-emerald-500", bgColor: "bg-white text-emerald-600" },
