      ...
      <div className="flex space-x-1 bg-slate-100/50 p-1 rounded-xl w-fit mb-8 border border-slate-200/60">
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg transition-all ${
            activeTab === "generate" ? "bg-white text-cyan-600 shadow-sm ring-1 ring-slate-200" : "text-slate-600 hover:text-slate-900 hover:bg-slate-200/50"
          }`}
        >
        ...
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg transition-all ${
            activeTab === "history" ? "bg-white text-cyan-600 shadow-sm ring-1 ring-slate-200" : "text-slate-600 hover:text-slate-900 hover:bg-slate-200/50"
          }`}
        >
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
            <div className="p-6 border-b border-slate-100 bg-slate-50/50 flex items-center gap-4">
               <div className="size-10 bg-cyan-50 text-cyan-600 rounded-xl flex items-center justify-center shrink-0">
            ...
            <form onSubmit={handleGenerateBill} className="p-6 space-y-6">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="relative">
                      ...
                      <input 
                        ...
                        placeholder="0.00"
                        className="w-full pl-9 pr-3 py-2 border border-slate-200 rounded-lg text-sm focus:ring-2 focus:ring-cyan-500/20 focus:border-cyan-500 outline-none"
                      />
                    </div>
                  </div>
                </div>
              ...
              <div className="pt-4 border-t border-slate-100">
                ...
                <div className="flex gap-4">
                  <label className={`flex-1 flex items-center justify-center gap-2 p-3 rounded-xl border cursor-pointer transition-colors ${
                    paymentStatus === "Paid" ? "bg-white border-emerald-500 text-emerald-700" : "bg-white border-slate-200 text-slate-600 hover:bg-slate-50"
                  }`}>
                    <input 
                      type="radio" 
                      name="status" 
              ...
              <div className="pt-6 mt-6 border-t border-slate-100 flex items-center justify-between">
                ...
                <button 
                  ...
                  className="px-6 py-3 bg-cyan-600 text-white rounded-xl text-sm font-medium hover:bg-cyan-700 transition-colors shadow-sm disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                >
               ...
               <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm w-full max-w-sm text-left">
                 <div className="flex justify-between items-start mb-6">
                   ...
                   <span className={`px-2 py-1 text-[10px] font-bold uppercase rounded-md border ${
                     paymentStatus === "Paid" ? "bg-white text-emerald-600 border-emerald-200" : "bg-amber-50 text-amber-600 border-amber-200"
                   }`}>
                     {paymentStatus}
                   </span>
                 </div>
                 ...
                 <div className="flex justify-between items-center">
                   ...
                   <span className="text-lg font-bold text-cyan-600">₹{totalAmount}</span>
                 </div>
               </div>
             )}
          </div>
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="pl-9 pr-4 py-2 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500/20 focus:border-cyan-500 w-64"
              />
            </div>
          </div>
